...
define config.name = _("PROJECT IPHIS")
...
define build.name = "PROJECTIPHIS"
...
define config.main_menu_music = "audio/act 3 final mix.mp3"
...
define config.save_directory = "PROJECTIPHIS-1773848124"
